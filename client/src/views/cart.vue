<template>
    <div >
                ...
                <li v-for="item in cartList">
                  <div class="cart-tab-1">
                    ...
                    <div class="cart-item-pic">
                      <img :src='"static/img/"+item.productImg'>
                    </div>
                  ...
                  <div class="cart-tab-2">
                    <div class="item-price">{{item.salePrice | price}}</div>
                  </div>
                  ...
                  <div class="cart-tab-4">
                    <div class="item-price-total">{{(item.salePrice * item.productNum) | price}}</div>
                  </div>
                  <div class="cart-tab-5">
                    <div class="cart-item-opration">
                      <a href="javascript:;" class="item-edit-btn" @click="loadDelFlag(item)">
            ...
            <div class="cart-foot-inner">
              ...
              <div class="cart-foot-r">
                <div class="item-total">
                  Item total: <span class="total-price">{{totalNum | price}}</span>
                </div>
                <div class="btn-wrap">
                  <a class="btn btn--red" @click="toAddress">Checkout</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <modal :md-flag="delFlag" @close="closeModal">
        ...
        <div slot="modal-btn">
          <a href="javascript:;"   class=" btn btn-login" @click="delCart()">确定</a>
    ...
    export default {
      ...
      methods:{
          ...
          toggleCheck(){
            ...
            axios.post('/user/edit/cartCheckAll',{
              userId:sessionStorage.userId,
              checkFlag:flag
            }).then(res=>{})
          },
