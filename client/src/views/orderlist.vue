      ...
      <div class="checkout-order">
              ...
              <li v-for="item in order">
                <div class="cart-tab-1">
                  <div class="cart-item-pic">
                    <img :src="'/static/img/'+item.productImg" alt="">
                  </div>
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total">{{item.productNum * item.salePrice | price}}</div>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            <button class="btn btn--m btn--red" @click="setOrder">Proceed to payment</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      totalOrder(){
        return this.subPrice+this.postage-this.discount+this.tax
      }
    },
    methods:{
      getOrder(){
